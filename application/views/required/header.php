...
function updateCartItem(obj,rowid){
    $.get("<?php echo base_url('site/updateItemQty/');?>", {rowid:rowid, qty:obj.value}, function(resp){
    if(resp=='ok'){
        location.reload();
    }
    else{
              ...
              <div class="right-side float-none-sm position-r">
                ...
                <div class="right-side float-left-xs header-right-link">
                  <ul>
                    ...
                    <li class="cart-icon"><a href="#"> <span> <small class="cart-notification"><?php echo $this->cart->total_items();  ?></small> </span> </a>
                      ...
                      ?>
                          <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                            <div class="media"> <a class="pull-left"> <img alt="Onlineshop" style="width: 100%; height: 70px;" src="<?php echo base_url();?>assets/products/<?php echo $cart['image']; ?>"></a>
                              <div class="media-body"> <span><a><?php echo $cart['name']; ?></a></span>
                                <p class="cart-price"><?php echo $cart['price']; ?></p>
                                <div class="product-qty">
                                  <label>Qty:</label>
                                  <div class="custom-qty">
                                    <input type="number" name="qty" value="<?php echo $cart['qty']; ?>" title="Qty" class="input-text qty">
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <p class="cart-sub-totle"> <span class="pull-left">Cart Total</span> <span class="pull-right"><strong class="price-box"><?php echo $this->cart->total(); ?></strong></span> </p>
                        <div class="clearfix"></div>
                        <div class="mt-20"> <a href="<?php echo base_url('site/cart');?>" class="btn-color btn">Cart</a> <a href="checkout.html" class="btn-color btn right-side">Checkout</a> </div>
                      </div>
                    </li>
